...
const QuestionCard = ({ que }) => {
	...
	return (
		...
		<div className='container mx-auto bg-primary text-white m-16 text-lg border-[5px] rounded-md border-primary'>
			{showScore ? (
				...
				<>
					<div className='question-section m-5'>
						...
						<div className='question-text flex justify-start'>{questions[currentQuestion].questionText}</div>
					</div>

					<div className='answer-section flex flex-col m-5 items-start '>
